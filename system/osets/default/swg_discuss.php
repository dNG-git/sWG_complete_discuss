...
function direct_output_oset_discuss_boards ()
{
	...
	{
		$f_return .= "\n<thead><tr>\n<td colspan='2' align='left' class='pagetitlecellbg' style='padding:$direct_settings[theme_td_padding]'><span class='pagetitlecellcontent'>";
...
<td colspan='2' align='left' class='pageextrabg' style='padding:$direct_settings[theme_form_td_padding]'><span class='pageextracontent' style='font-size:10px'><a href=\"{$direct_cachedata['output_board']['pageurl_parent']}\" target='_self'>".(direct_local_get ("core_level_up"))."</a></span></td>
	...
	else { $f_return .= ((strlen ($direct_cachedata['output_board']['title_alt'])) ? "<span class='pagecontent' style='font-weight:bold'>{$direct_cachedata['output_board']['title_alt']}</span>" : "<span class='pagecontent' style='font-weight:bold'>{$direct_cachedata['output_board']['title']}</span>"); }
...
<span style='font-weight:bold'>".(direct_local_get ("discuss_posts")).":</span> {$direct_cachedata['output_board']['posts']}</span></td>
	...
	$f_return .= (($direct_cachedata['output_topic']['desc']) ? "\n<thead><tr>\n<td colspan='2' align='left' class='pagetitlecellbg' style='padding:$direct_settings[theme_td_padding]'><span class='pagetitlecellcontent'>{$direct_cachedata['output_topic']['title']}</span></td>" : "\n<thead class='pagehide'><tr>\n<td colspan='2' align='left' class='pagetitlecellbg' style='padding:$direct_settings[theme_td_padding]'><span class='pagetitlecellcontent'>".(direct_local_get ("discuss_topic"))."</span></td>");
	$f_return .= "\n</tr></thead><tbody><tr>\n<td valign='middle' align='left' class='pagebg' style='width:84%;padding:$direct_settings[theme_td_padding]'>";
	...
	{
		$f_return .= "<img src='".(direct_linker_dynamic ("url0","s=cache&dsd=dfile+$direct_settings[path_themes]/$direct_settings[theme]/status_comment_new.png",true,false))."' border='0' alt='".(direct_local_get ("discuss_topic_new_posts"))."' title='".(direct_local_get ("discuss_topic_new_posts"))."' id='{$direct_cachedata['output_topic']['id']}_new' style='float:right' /><script language='JavaScript1.5' type='text/javascript'><![CDATA[\n";

		if (isset ($direct_cachedata['output_board']))
		{
$f_return .= ("if (!djs_swgStorage_new_check ('{$direct_cachedata['output_topic']['oid']}','{$direct_cachedata['output_board']['oid']}','{$direct_cachedata['output_topic']['posts']}')) { djs_swgDOM_replace (\"<img src='".(direct_linker_dynamic ("url0","s=cache&dsd=dfile+$direct_settings[path_themes]/$direct_settings[theme]/status_comment_new_viewed.png",true,false))."' border='0' alt='".(direct_local_get ("discuss_board_new_posts"))."' title='".(direct_local_get ("discuss_topic_new_posts"))."' style='float:right' />\",'{$direct_cachedata['output_topic']['id']}_new'); }
djs_swgStorage_new_read ('{$direct_cachedata['output_topic']['oid']}','{$direct_cachedata['output_board']['oid']}','{$direct_cachedata['output_topic']['posts']}');");
		}
		else
		{
$f_return .= ("if (!djs_swgStorage_new_check ('{$direct_cachedata['output_topic']['oid']}',null,'{$direct_cachedata['output_topic']['posts']}')) { djs_swgDOM_replace (\"<img src='".(direct_linker_dynamic ("url0","s=cache&dsd=dfile+$direct_settings[path_themes]/$direct_settings[theme]/status_comment_new_viewed.png",true,false))."' border='0' alt='".(direct_local_get ("discuss_board_new_posts"))."' title='".(direct_local_get ("discuss_topic_new_posts"))."' style='float:right' />\",'{$direct_cachedata['output_topic']['id']}_new'); }
djs_swgStorage_new_read ('{$direct_cachedata['output_topic']['oid']}',null,'{$direct_cachedata['output_topic']['posts']}');");
		}
	...
	$f_return .= ($direct_cachedata['output_topic']['desc'] ? "<span class='pagecontent' style='font-size:10px'>{$direct_cachedata['output_topic']['desc']}</span>" : "<span class='pagecontent' style='font-weight:bold'>{$direct_cachedata['output_topic']['title']}</span>");
...
<td colspan='2' align='left' class='pageextrabg' style='padding:$direct_settings[theme_form_td_padding]'><span class='pageextracontent' style='font-size:10px'><a href=\"{$direct_cachedata['output_board']['pageurl_parent']}\" target='_self'>".(direct_local_get ("core_level_up"))."</a></span></td>
	...
	if ($direct_cachedata['output_board']['new'])
	{
$f_return .= ("<a id='{$direct_cachedata['output_board']['id']}_new' href='{$direct_cachedata['output_board']['last_post_jump']}' target='_self'><img src='".(direct_linker_dynamic ("url0","s=cache&dsd=dfile+$direct_settings[path_themes]/$direct_settings[theme]/status_comment_new.png",true,false))."' border='0' alt='".(direct_local_get ("discuss_board_new_posts"))."' title='".(direct_local_get ("discuss_board_new_posts"))."' style='float:right' /></a><script language='JavaScript1.5' type='text/javascript'><![CDATA[
if (!djs_swgStorage_new_unread_check ('{$direct_cachedata['output_board']['oid']}','{$direct_cachedata['output_board']['posts']}')) { djs_swgDOM_replace (\"<a href='{$direct_cachedata['output_board']['last_post_jump']}' target='_self'><img src='".(direct_linker_dynamic ("url0","s=cache&dsd=dfile+$direct_settings[path_themes]/$direct_settings[theme]/status_comment_new_viewed.png",true,false))."' border='0' alt='".(direct_local_get ("discuss_board_new_posts"))."' title='".(direct_local_get ("discuss_board_new_posts"))."' style='float:right' /></a>\",'{$direct_cachedata['output_board']['id']}_new'); }
djs_swgStorage_new_read ('{$direct_cachedata['output_board']['oid']}',null,'{$direct_cachedata['output_board']['posts']}');
]]></script>");
	}
...
<span style='font-weight:bold'>".(direct_local_get ("discuss_posts")).":</span> {$direct_cachedata['output_board']['posts']}</span></td>
	...
	else
	{
		...
		{
$f_return .= ("<tr>
<td colspan='3' align='center' class='pageextrabg' style='padding:5px'><span class='pageextracontent' style='font-size:10px'>".(direct_output_pages_generator ($direct_cachedata['output_page_url'],$direct_cachedata['output_pages'],$direct_cachedata['output_page']))."</span></td>
</tr>");
		}
...
function direct_output_oset_discuss_topics_latest ()
{
	...
	$f_return = "<p class='pagecontenttitle'>".(direct_local_get ("discuss_topics_latest"))."</p>\n";
	...
	{
		if ($direct_cachedata['output_pages'] > 1) { $f_return .= "<p class='pageborder2' style='text-align:center'><span class='pageextracontent' style='font-size:10px'>".(direct_output_pages_generator ("m=discuss&a=latest&dsd=ddid+$direct_cachedata[output_did]++dhours+{$direct_cachedata['output_hours']}++",$direct_cachedata['output_pages'],$direct_cachedata['output_page']))."</span></p>\n"; }
		$f_return .= direct_oset_discuss_topics_latest_parse ($direct_cachedata['output_topics']);
		if ($direct_cachedata['output_pages'] > 1) { $f_return .= "\n<p class='pageborder2' style='text-align:center'><span class='pageextracontent' style='font-size:10px'>".(direct_output_pages_generator ("m=discuss&a=latest&dsd=ddid+$direct_cachedata[output_did]++dhours+{$direct_cachedata['output_hours']}++",$direct_cachedata['output_pages'],$direct_cachedata['output_page']))."</span></p>"; }
	}
